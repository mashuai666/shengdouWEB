    ...
    <div class="product-server main">
      ...
      <div class="product-right-content">
        ...
        <div class="hot right_l_scroll">
          ...
          <router-link to="/productDetail?productId=SD20TSM01H" title="点击查看产品详情" alt="点击查看产品详情">
            <div class="hot-con">
              <div class="hot-con-img">
                <img v-lazy='this.$store.getters.getproductlist.proSD20TSM01H.cardImg' alt="">
              </div>
              <div class="hot-right-con">
                <div>{{this.$store.getters.getproductlist.proSD20TSM01H.name}}</div>
                <div>{{this.$store.getters.getproductlist.proSD20TSM01H.cardDetail}}</div>
